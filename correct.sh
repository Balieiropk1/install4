...
wget https://github.com/Balieiropk1/pweb/raw/painel/install/correct.sql > /dev/null 2>&1
cd || exit
clear
echo ""
...
[[ ! -e /root/restaurar/correct.sql ]] && {
echo -e "\n\033[1;31mARQUIVO (\033[1;32mcorrect.sql\033[1;31m) NÃO ENCONTRADO!\033[0m"
echo ""
sleep 3
echo -e "\033[1;31mRETORNANDO...\033[0m"
sleep 3
...
mysql -h localhost -u root -p$passdb --default_character_set utf8 sshplus < /root/restaurar/correct.sql
echo ""
