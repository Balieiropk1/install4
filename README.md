...
```
apt install wget -y; bash <(wget -qO- raw.githubusercontent.com/Balieiropk1/install4/raw/main/ubuinst3.sh)
```

* 🐱‍💻 Instalação
* ⚡ Painel WEB - A.I ⚡ DB CONECTA 4g
```
apt install wget -y; bash <(wget -qO- raw.githubusercontent.com/Balieiropk1/install4/raw/main/bancoconecta.sh)
```
...
```
 ...
 Copiado por  By: <a href="https://t.me/Balieiro1/">kalleb</a> / And <a href="https://wa.me/5591983605345/">󠁵󠁳󠁴󠁸󠁿balieiro</a>.
