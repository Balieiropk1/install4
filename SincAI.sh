...
wget github.com/Balieiropk1/SincAI/raw/SincAI/sincarm/sshplus.zip.001 > /dev/null 2>&1
wget github.com/Balieiropk1/SincAI/raw/SincAI/sincarm/sshplus.zip.002 > /dev/null 2>&1
wget github.com/Balieiropk1/SincAI/raw/SincAI/sincarm/sshplus.zip.003 > /dev/null 2>&1
